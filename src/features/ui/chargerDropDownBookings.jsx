...
const Type1Component = () => <div class="relative overflow-x-auto"><Type1RecentSessionData showActions={true}/></div>;
const Type2Component = () => <div class="relative overflow-x-auto"><Type2RecentSessionData showActions={true}/></div>;
const CHAdeMOComponent = () => <div class="relative overflow-x-auto"><CHAdeMORecentSessionData showActions={true}/></div>;
const CCS2Component = () => <div class="relative overflow-x-auto"><CCS2RecentSessionData showActions={true}/></div>;

export default function ChargerDropDownBookings() {
