...
const CHAdeMORecentSessionData = ({ showActions = false }) => {
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-center text-neutral-800 text-sm font-bold font-['Roboto'] bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        {showActions && <th scope="col" className="px-6 py-3">Action</th>}
                    </tr>
                </thead>
                <tbody>
                    {sessionData.map((session, index) => (
                        ...
                        >
                            ...
                            <td className="px-6 py-4">{session.energyUsed}</td>
                            <td className="px-6 py-4">{session.cost}</td>
                            {showActions && <td className="px-6 py-4"><ActionDropdownMenu /></td>}
                        </tr>
                    ))}
                </tbody>
            </table>
...
export default CHAdeMORecentSessionData;
