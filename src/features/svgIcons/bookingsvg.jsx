        ...
        >
            <div class="flex flex-row">
                <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
                    ...
                    <path d="M26.1603 13.2915C23.369 15.3215 20.179 16.5298 16.9165 16.9407" fill={iconColor} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M3.16553 13.6177C5.88428 15.4785 8.95344 16.6023 12.083 16.9527" fill={iconColor} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <div class={`text-[18px] font-normal ml-[20px] font-['Roboto'] tracking-tight ${textColor}`} >Booking</div>
            </div>
        </button >
    );
};
